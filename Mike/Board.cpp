...
Board::Board()
{
	...
	spaces.push_back(new Property(1, "Pasquerilla East", -1, 0, 0, 0, 60, 0, 0, 2, 0, 0));
	spaces.push_back(new CardSpaces(0, "S.A.O.", -1, 0, 2, 0));
	spaces.push_back(new Property(1, "Pasquerilla West", -1, 0, 0, 0, 60, 0, 0, 4, 0, 0));
	spaces.push_back(new Tax(0, "Hall Tax", -1, -75, 0, 0));
	spaces.push_back(new Railroad(9, "Coleman Morris Center", -1, 0, 0, 0, 200, 25, 0));	
	spaces.push_back(new Property(2, "Seigfried Hall", -1, 0, 0, 0, 100, 0, 0, 6, 0, 0));
	spaces.push_back(new CardSpaces(0, "S.U.B.", -1, 0, 1, 0));				//might need a new class, some way of calling cards				
	spaces.push_back(new Property(2, "Lewis Hall", -1, 0, 0, 0, 100, 0, 0, 6, 0, 0));
	spaces.push_back(new Property(2, "Carrol Hall", -1, 0, 0, 0, 120, 0, 0, 8, 0, 0));
	spaces.push_back(new Jail(0, "Res Life", -1, 0, 0, 0));				//need a new class for this likely
	spaces.push_back(new Property(3, "Fisher Hall", -1, 0, 0, 0, 140, 0, 0, 10, 0, 0));
	...
	spaces.push_back(new Property(3, "Dillon Hall", -1, 0, 0, 0, 140, 0, 0, 10, 0, 0));
	spaces.push_back(new Property(3, "Alumni Hall", -1, 0, 0, 0, 160, 0, 0, 12, 0, 0));
	spaces.push_back(new Railroad(9, "DeBartolo Hall", -1, 0, 0, 0, 200, 25, 0));	//need a different moneyEffect function for railroads
	spaces.push_back(new Property(4, "Badin Hall", -1, 0, 0, 0, 180, 0, 0, 14, 0, 0));
	spaces.push_back(new CardSpaces(0, "S.A.O.", -1, 0, 2, 0));
	spaces.push_back(new Property(4, "Howard Hall", -1, 0, 0, 0, 180, 0, 0, 14, 0, 0));
	spaces.push_back(new Property(4, "Lyons Hall", -1, 0, 0, 0, 200, 0, 0, 16, 0, 0));
	spaces.push_back(new Bland(0, "D6 Parking", -1, 0, 0, 0));
	spaces.push_back(new Property(5, "Ryan Hall", -1, 0, 0, 0, 220, 0, 0, 18, 0, 0));
	spaces.push_back(new CardSpaces(0, "S.U.B.", -1, 0, 1, 0));
	spaces.push_back(new Property(5, "McGlinn Hall", -1, 0, 0, 0, 220, 0, 0, 18, 0, 0));
	spaces.push_back(new Property(5, "Welsh Family Hall", -1, 0, 0, 0, 240, 0, 0, 20, 0, 0));
	spaces.push_back(new Railroad(9, "Lafortune Student Center", -1, 0, 0, 0, 200, 25, 0));
	spaces.push_back(new Property(6, "O'Neill Hall", -1, 0, 0, 0, 260, 0, 0, 22, 0, 0));
	spaces.push_back(new Property(6, "Keough Hall", -1, 0, 0, 0, 260, 0, 0, 22, 0, 0));
	spaces.push_back(new Utility(10, "South Dining Hall", -1, 0, 0, 0, 150, 10, 0, 0));
	spaces.push_back(new Property(6, "Duncan Hall", -1, 0, 0, 0, 280, 0, 0, 24, 0, 0));
	spaces.push_back(new Jail(0, "Go to Res Life", -1, 0, 0, 0));			//almost definitely need a new class, need a way of moving player
	spaces.push_back(new Property(7, "Compton Ice Arena", -1, 0, 0, 0, 300, 0, 0, 26, 0, 0));
	spaces.push_back(new Property(7, "J.A.C.C.", -1, 0, 0, 0, 300, 0, 0, 26, 0, 0));
	spaces.push_back(new CardSpaces(0, "S.A.O.", -1, 0, 2, 0));
	spaces.push_back(new Property(7, "Notre Dame Stadium", -1, 0, 0, 0, 320, 0, 0, 28, 0, 0));
	spaces.push_back(new Railroad(9, "Hesburgh Library", -1, 0, 0, 0, 200, 25, 0));
	spaces.push_back(new CardSpaces(0, "S.U.B.", -1, 0, 1, 0));
	spaces.push_back(new Property(8, "Main Building", -1, 0, 0, 0, 350, 0, 0, 35, 0, 0));
	spaces.push_back(new Tax(0, "Luxury Tax", -1, -75, 0, 0));
	spaces.push_back(new Property(8, "The Grotto", -1, 0, 0, 0, 400, 0, 0, 50, 0, 0));
